    ...
    <Layout>
      <About>
        <ContainerBox>
          ...
          <Subtitle>
            It seems you may want to get more details about me.
          </Subtitle>
          <Paragraph>
          ...
          <SecondPart>
            ...
            <Paragraph>
              I also used robotic liquid handlers such as TomTec Quadra or CyBio
            ...
            <Paragraph>
              I was again so lucky that I gained insights to most parts of
              nonclinical tests from dosing of test subjects, most TK studies,
              in vitro and ADME work, as well as metabolite identification.
            </Paragraph>
            <Paragraph>
              I learnt a lot at some of the biggest and best (bio)analytical
              labs in the UK and Europe. Each place provided something extra and
              new. It was very interesting to see the different approaches to
              certain tasks at each place, as these all became the basis of my
              approach to method development and documentation, to make things
              more effective, quicker and easier. I would like to present you
              this combined knowledge, the essence of what I learnt at all these
              excellent labs.
            </Paragraph>
